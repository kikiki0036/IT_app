...
function ConfirmationDialogRaw(props) {
  const { onClose,setValue, open, ...other } = props;
          ...
          <div className="dialog-box-input dialogContent">
                ...
                <table>
                  ...
                  <tbody className="dialog-table-body-h">
                      {
                        rows.map((row) => (
                            <tr key={row.id_emp} onClick={() => {handleClose(); setValue({id:row.id_emp, section:row.sections[0].section, email:row.user_profiles[0].email})}}>
                              <td>{row.id_emp}</td>
