...
function ConfirmationDialogRaw(props) {
  const { onClose,setValue, valueProp, open, ...other } = props;
  ...
  return (
    <Dialog
      ...
      {...other}
    >
      <DialogTitle sx={{pb:0}} >Phone Ringtone</DialogTitle>
          ...
          <div className="dialog-box-input dialogContent">
                ...
                <table>
                  ...
                  <tbody className="dialog-table-body-h">
                      {
                        rows.map((row) => (
                            <tr key={row.id_it} onClick={() => {handleClose(); setValue({id:row.id_it, section:row.user_profiles[0].data_emps[0].sections[0].section, email:row.user_profiles[0].email})}}>
                              <td>{row.id_it}</td>
                              <td className="font-kanit">{row.user_profiles[0].data_emps[0].emp_name}</td>
                              <td className="transform-none-txt">{row.user_profiles[0].email}</td>
                              <td>{row.user_profiles[0].data_emps[0].sections[0].section}</td>
                            </tr>
                        ))
                      }
