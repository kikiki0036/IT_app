  ...
  return (
    ...
    <React.Fragment>
      <tr key={row.job_no} sx={{ '& > *': { borderBottom: 'unset' } }} >
        ...
        <td className="col_txt">{subName(row.erp_rights[0].it_name)}</td>
      </tr>
      <tr>
                    ...
                    <table size="small" aria-label="purchases">
                      ...
                      <tbody>
                          ...
                          <tr key={row.service_tikkets[0].tikket_no+"3"}>
                            ...
                            <td className="hiden-col"></td>
                            <td className="b-rl"><td className="title-row">appove by</td><td className="">: &nbsp;{subName(row.erp_rights[1].it_name)}</td></td>
                          </tr>
                          <tr key={row.service_tikkets[0].tikket_no+"4"}>
                            ...
                            <td className="hiden-col"></td>
                            <td className="b-rl"><td className="title-row">Assign</td><td className="">: &nbsp;{subName(row.erp_rights[0].it_name)}</td></td>
                          </tr>
                  ...
                  <div className="txt-detail">
                    ...
                    <table size="small" aria-label="purchases" className="service-option font-kanit">
                      ...
                      <tbody className="border-rl">
                        ...
                        {row.service_tikkets[0].item_tks.map((tikketdetailRow) => (
                            <tr key={tikketdetailRow.id_item}>
        ...
        <div className="table-wrapper">
          <Root>
              <table aria-label="collapsible table">
                ...
                <tbody>
                  {dataShow.map((row) => (
                    <RowData key={row.job_no} row={row} />
                  ))}
                </tbody>
              </table>
          </Root>
