          ...
          <div className="detail-req-step-2">
            ...
            <div className="box-fields-input-50">
              ...
              <div className="box-fields" id="box-fields">
                    ...
                    <div className="input-req">
                      <CssTextField className="field-req" id='tel' name='tel' label='Tel' type="text" variant="standard"
                        // value={name} onChange={handleChange}
                      />
                    </div> 
                    <div className="input-req">
                            ...
                            <div className="in-box">
                              <LocalizationProvider dateAdapter={AdapterDateFns}  locale={th} >
                                <MobileDateTimePicker
                                  renderInput={(props) => <CssTextField {...props}  className="field-req"  id='jobstart'  name='jobstart' label='Job start'  variant="standard"  InputProps={{
                                    endAdornment: (
                                      <InputAdornment position="end">
