...
const ConfirmationDialogRaw = (props) => {
          ...
          const { handleAdd, onClose, open, ...other } = props;
...
const Detail_req = () => {
        ...
        const handleClose = (newValue) => { setOpen(false);  setValue(newValue); };
        ...
        const HandleAdd = (item) => {
          ...
          for(let obj in item) {
            if(item[obj].status == true) {
                ...
                getItemAdd.id = item[obj].id_item; 
                ...
                ReactDOM.render(element, document.getElementById(item[obj].id_item));

            } else if(item[obj].status == false) {

                const getItemRemove = document.getElementById(item[obj].id_item);
          ...
          <div className="detail-req-step-2">
            ...
            <div className="box-fields-input-55">
              <div className="box-fields" id="box-fields">
                  ...
                  {/* <div className="input-req"  id="remove">
                    <CssTextField
                      className="field-req"
                      id="remove"
                      label="remove"
                  ...
                  {items.map((row) => (
                    <div className="input-req" key={row.id_item} id={row.id_item}>
                      <CssTextField
                        className="field-req"
                        id={row.id_item}
